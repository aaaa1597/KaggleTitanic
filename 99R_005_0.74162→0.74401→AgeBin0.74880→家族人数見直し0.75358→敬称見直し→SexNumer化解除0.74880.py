...
all_data = pd.get_dummies(all_data, columns=['Title', 'FamilySizeGroup', 'AgeBin', 'Sex'])
...
##### 提出ファイル出力
submission.to_csv("submission-99R_004_0.75358_000.csv", index=False)

##### 完了
print("submission-99R-004_0.75358_000.csv を作成しました")
